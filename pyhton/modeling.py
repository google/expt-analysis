...
def fitPredModel(data, modExpr=None, explanCols=None, yCols=None,
                 ...
                 printSummary=False, plotIt=False):
...
res = fitPredModel(data=df2,modExpr=None,explanCols=explanCols,yCols=yCols,
    ...
    indTrain=None,indValid=None,predFcn=None,printSummary=False,plotIt=False)
...
res = fitPredModel(data=df2,modExpr=None,explanCols=explanCols,yCols=yCols,
    ...
    indTrain=None,indValid=None,predFcn=None,printSummary=False,plotIt=True)
